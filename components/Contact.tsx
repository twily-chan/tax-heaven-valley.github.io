            ...
            <div className="space-y-6 md:space-y-8 relative z-10">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-paper-200 text-xs md:text-sm">Tax Heaven Valley<br />100 Legal Avenue, Suite 4<br />Dhaka, Bangladesh</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-paper-200 text-xs md:text-sm">+880 1711-000000</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-paper-200 text-xs md:text-sm">nasir@taxheavenvalley.com</p>
                </div>
              </div>
            </div>
          </div>
